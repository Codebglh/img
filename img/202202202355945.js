    ...
    A: function() {
        ...
        for (var j in list) {
            d.push({
                ...
                url: "hiker://empty##" + pd(list[j], 链接).replace('window.open\/\'|\'\)', '') + "#immersiveTheme#"
            });
        }
        setResult(d)
    },
    ...
    A: function() {
        ...
        for (var j in list) {
            d.push({
                ...
                img: pd(list[j], 图片) + "@Referer=",
                url: "hiker://empty##" + pd(list[j], 链接).replace('play', 'detail').replace('/sid/1/nid/1', '').replace('-1-1', '') + "#immersiveTheme#"
            });
        }
        res.data = d;
        setSearchResult(res);
    ...
    C: function() {
        ...
        pdfa(html, 列表).forEach(list => {
            d.push({
                ...
                url: "hiker://empty##" + pd(list, 链接).replace('play', 'detail').replace('/sid/1/nid/1', '').replace('-1-1', '') + "#immersiveTheme#"
            });
        })
        setResult(d)
    }
